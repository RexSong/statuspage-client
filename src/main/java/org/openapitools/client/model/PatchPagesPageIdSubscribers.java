 ...
 * Update a subscriber
 */
@ApiModel(description = "Update a subscriber")
...
public class PatchPagesPageIdSubscribers {
  ...
  public PatchPagesPageIdSubscribers componentIds(List<String> componentIds) {
    
    this.componentIds = componentIds;
    return this;
  }

  public PatchPagesPageIdSubscribers addComponentIdsItem(String componentIdsItem) {
  ...
  **/
  ...
  @ApiModelProperty(value = "A list of component ids for which the subscriber should recieve updates for. Components must be an array with at least one element if it is passed at all. Each component must belong to the page indicated in the path. To set the subscriber to be subscribed to all components on the page, exclude this parameter.")
  ...
  public boolean equals(Object o) {
    ...
    PatchPagesPageIdSubscribers patchPagesPageIdSubscribers = (PatchPagesPageIdSubscribers) o;
    return Objects.equals(this.componentIds, patchPagesPageIdSubscribers.componentIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchPagesPageIdSubscribers {\n");
