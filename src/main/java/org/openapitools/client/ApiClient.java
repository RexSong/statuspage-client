...
public class ApiClient {
    ...
    private String basePath = "https://api.statuspage.io/v1";
    ...
    public ApiClient() {
        ...
        apiKeyAuth.setApiKeyPrefix("OAuth");
        apiKeyAuth.setApiKey("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx");
    ...
    public ApiClient(OkHttpClient client) {
        ...
        ApiKeyAuth apiKeyAuth = new ApiKeyAuth("header", "Authorization");
        apiKeyAuth.setApiKeyPrefix("OAuth");
        apiKeyAuth.setApiKey("a64f3709-efd9-4c61-9413-3452d7b458a5");
        authentications.put("api_key", apiKeyAuth);
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.statuspage.io/v1
